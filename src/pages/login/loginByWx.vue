...
<template>
  <view class="wrap bgWhite" >
    ...
    <view class="middle bgWhite">
      ...
      <view class="tac fs30 gray paddingTop">输入微信手机号码绑定微信使用</view>
...
<script>
  ...
  export default class LoginByWx extends wepy.page {
    config = {
    ...
    methods = {
      async submitData(){
        ...
        let res = await http.post('/bindingTel',{
    ...
    onLoad() {
       this.opid = wx.getStorageSync('opid');
    }
  }
</script>
